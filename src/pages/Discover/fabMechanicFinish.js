...
const MechanicFinish = () => {
  ...
  useEffect(() => {
    ...
    const getProject = async () => {
      try {
        ...
        idDoc.forEach(docIdRef => {projectNameData.push(docIdRef.projectName)});
        const panelNameData = [];
  ...
  return (
    <View style={{marginVertical: 10}}>
      <Header/><Title2 TxtTitle="WORK FINISHED" SubTitle="MECHANICAL" />
      {isLoading ? (<></>) : (<>

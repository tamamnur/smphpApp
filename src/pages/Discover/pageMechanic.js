...
const PageMechanic = () => {
  ...
  return (
    ...
    <TitlePages Title={'MECHANICAL'} Subtitle={'FABRICATION'}/>
      <View style={{alignSelf: 'center', flexDirection: 'row', marginBottom: 20}}>
        <ButtonStart onPress={()=>navigation.navigate('MechanicStart')}/>
        <ButtonFinish onPress={()=> navigation.navigate('MechanicFinish')}/>
         </View>
      {isDivision && (
